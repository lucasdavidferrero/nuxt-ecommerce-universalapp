...
<template>
  <div class="relative flex flex-col w-full max-h-[600px] lg:max-h-[350px] aspect-[4/3]">
    <SfScrollable
    ...
    >
      ...
      >
        <img :aria-label="alt" :aria-hidden="activeIndex !== index" class="w-auto h-full lg:h-[350px]" :alt="alt" :src="imageSrc" />
      </div>
    </SfScrollable>
    <SfScrollable
