...
<template>
  <div class="lg:flex gap-x-4 items-center">
    <div class="lg:w-7/12">
      <NuxtImg src="/img/BannerSeccionMuebles.jpg" class="object-cover lg:w-full" />
    </div>
    <div class="lg:overflow-x-hidden lg:w-5/12">
      <!-- Slider de 2 productos -->
      <SfScrollable
      ...
      >
        ...
        <div
            ...
            :key="aik_ar_codigo"
            class="first:ms-auto last:me-auto border border-neutral-200 shrink-0 rounded-md hover:shadow-lg w-[200px] lg:w-[220px] bg-white h-full"
        >
