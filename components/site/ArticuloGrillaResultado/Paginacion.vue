...
<template>
  <nav class="flex justify-between items-end border border-neutral-200 bg-white p-4 rounded-md" role="navigation" aria-label="pagination">
    <SfButton
        size="lg"
    ...
    >
      ...
      <span class="hidden sm:inline-flex"> Anterior </span>
    </SfButton>
    ...
    <SfButton
        ...
        @click="next"
    >
      <span class="hidden sm:inline-flex"> Siguiente </span>
      <template #suffix>
        <SfIconChevronRight />
      </template>
    </SfButton>
